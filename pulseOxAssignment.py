...
threshold_list = np.arange(88.5, 97.5, 1.0)
...
for i, threshold in enumerate(threshold_list):
	...
	plt.text(p_FA_w[i], p_D_w[i], str(threshold), horizontalalignment='right')
	plt.text(p_FA_b[i], p_D_b[i], str(threshold), horizontalalignment='left')
