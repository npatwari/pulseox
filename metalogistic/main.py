...
class _MetaLogisticMonoFit(stats.rv_continuous):
	...
	def display_plot(self, p_from_to=(.001, .999), x_from_to=(None, None), n=100, hide_extreme_densities=50, color='b'):
		"""
		...
		cdf_axis.plot(cdf_data['X-values'], cdf_data['Probabilities'], color)
